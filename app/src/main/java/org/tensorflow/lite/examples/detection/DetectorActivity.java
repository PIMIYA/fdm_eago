...
//update UI custom indicators
  private void setWith_mask(){
  ...
  private void onFacesDetected(long currTimestamp, List<Face> faces) {
    ...
    for (Face face : faces) {
      ...
      if (boundingBox != null && goodConfidence) {
        ...
        if (getCameraFacing() == CameraCharacteristics.LENS_FACING_EXTERNAL) { // LENS_FACING_FRONT
